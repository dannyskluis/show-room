document.addEventListener("DOMContentLoaded", function () {
    ...
    let navContent = `
        <ul class='nav'>
            ...
            <li class='menu_item'><a href='messages.php'>Communicate</a></li>
            <li class='menu_item'><a href='add_appointment.php'>Make an appointment</a></li>
            <li class='menu_item'><a href='history_appointments.php'>Appointments</a></li>
        ...
        if (unreviewedAppointments.length > 0) {
            unreviewedAppointments.forEach(appointment => {
                navContent += `<li>Your appointment on ${new Date(appointment.APPOINTMENT_DATETIME).toLocaleString('en-GB', { 
                    ...
                    minute: '2-digit', 
                    hour12: false 
                })} is not yet reviewed. <a href='review.php?id=${appointment.APPOINTMENT_ID}' class='btn btn-review'>Review here</a></li>`;
