...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $datum = $_POST['datum'];
    $activity->wijzigActiviteit($db, $id, $naam, $beschrijving, $datum);
    $message = "Activiteit succesvol gewijzigd!";
}
?>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="activity-wijzigen.php">Wijzigen</a></li>
    ...
    <div class="container mt-4">
        <h1 class="text-center mb-4">Activiteit Wijzigen</h1>
        ...
        <form method="POST" class="bg-light p-4 rounded shadow-sm">
            ...
            <button type="submit" class="btn btn-success w-100">Wijzigen</button>
        </form>
    </div>
